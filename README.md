...
- I created a locked branch for CodeKy.
- See the CodeKy Branch and the project.md for CodeKy Specific Info.
...
- The demo runs slowly in LiveServer, I recommend using:
  - https://cjmet.github.io/WeatherKitty/
  - npm run dev
  - npx vite
